...
#Concepto de realidades los cuales usar con tal de trabajar en pro del
#emprendimiento del saber.

print('construccion de mente')


#Los locos que manejan supercomputadoras
#Esta version de la realidad sucede cuando amplificamos las verdades de nuestro saber.
...
while(booleanoGo_1):
    ...
    try:
        ...
        print3()
        stringIn_0 = input()
        os.system('git remote add origin ' + stringIn_0)
        print3()
        os.system('git add .')
        print3()
...
#Simplemente no tiene precio la evolucion, es una caracteristica que te ayuda a definir
#esas relaciones que fomentan como eres como sujeto, como eres como identidad
#Que clase de personalidad tu puedes expresar en el ahora
#Que misterios tu puedes emprender.
#Esos valores que te determinan como sujeto.

#Esto esta buenisimo, porque puedo trabajarle a la expresion que me permite sintetizar
#sintetizr propiedades relaciones comportamientos etc.
#En este comportamiento nosotros definimos como es que se pueden establecer contextos
#los cuales hacer para dar para dar vida.